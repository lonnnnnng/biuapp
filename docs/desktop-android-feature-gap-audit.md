...
- 审计日期：2026-08-01
- Git 分支：`main`
- Android 版本：`0.1.11` + 未发布 M11 用户/关注、M12 动态互动与 M12.1 热门推荐分页改动
...
- 综合热门、每周必看、全站排行、视频搜索和自选关注 UP 首页；默认热门与自选 UP 内容均支持上滑续载。
...
- 关注视频动态支持真实账号游标分页、直接播放、点赞/取消点赞和带确认的一键三连；Redmi 已完成点赞往返验收，真实三连扣币尚未执行。
